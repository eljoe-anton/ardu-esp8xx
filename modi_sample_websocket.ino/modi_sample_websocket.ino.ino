...
void webSocketEvent(uint8_t num, WStype_t type, uint8_t * payload, size_t lenght) {
    Serial.printf("[%u] Ha llegado un mensaje: %s\r\n", num, payload);
    switch(type) {
        ...
        case WStype_TEXT:
            {
              ...
              //Serial.println("Este es el mensaje que llego: %s,  y se cumplio que es texto\r\n", payload);
...
void updateLed(String idLed, int intLed){
  Serial.println("Actualizando salidas de acuerdo a mensaje recibido!");
